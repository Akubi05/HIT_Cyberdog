...
class example_t(object):
    ...
    __slots__ = ["timestamp", "position", "name", "enabled"]

    __typenames__ = ["int64_t", "double", "string", "boolean"]

    __dimensions__ = [None, [3], None, None]
    ...
    def _get_hash_recursive(parents):
        ...
        tmphash = (0xbe17613534872997) & 0xffffffffffffffff
