            ...
            if ( motion_trigger_ == 0 && command_.cmd_source != kCyberdogLcmCmd ) {
                ...
                if ( robotType == RobotType::CYBERDOG2 ) {
                    ...
                    case MotionId::kMotionUser11:
                        ...
                        break;
                    case MotionId::kMotionUser12:
                        MotionListCppTomlRead( GetUserGaitParameterPath() + "cyberdog2_user92_upslope.toml" );
                        break;
                    case MotionId::kMotionUser13:
                        MotionListCppTomlRead( GetUserGaitParameterPath() + "cyberdog2_user93_downslope.toml" );
                        break;
