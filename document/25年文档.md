...
- 安装docker,ros galactic
  ...
  - 可能出现的部分错误请查看相关文档[ros2安装](ros2安装.md)
  - git、curl设置代理。[点击查看相关文档](git、curl设置代理.md)
  - `curl -s https://raw.githubusercontent.com/ros/rosdistro/master/ros.asc | sudo apt-key add -`无法运行。[点击查看相关文档](raw.github_error.md)
- 下载比赛压缩包
