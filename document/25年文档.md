...
- 安装docker,ros galactic
  ...
  docker安装[点击查看相关文档](/cyberdog/document/docker.md)

  https://docs.ros.org/en/galactic/Installation/Ubuntu-Install-Debians.html

  - 可能出现的部分错误请查看相关文档[ros2安装](/cyberdog/document/ros2安装.md)
  - git、curl设置代理。[点击查看相关文档](/cyberdog/document/git、curl设置代理.md)
  - `curl -s https://raw.githubusercontent.com/ros/rosdistro/master/ros.asc | sudo apt-key add -`无法运行。[点击查看相关文档](/cyberdog/document/raw.github_error.md)
- 下载比赛压缩包
...
- 首先我们要把这个比赛docker展开，方便修改代码
  ...
  ![](/cyberdog/document/pictures/1.png)
...
- 进入`~/projects/sim/cyberdog_sim`文件夹，阅读`REDAME.md`,**安装依赖**
  ![](/cyberdog/document/pictures/2.png)
  注意安装lcm的时候可能报错
  ![](/cyberdog/document/pictures/3.png)
  可以不用管，直接make就行

- 仿真使用
  详见https://miroboticslab.github.io/blogs/#/cn/cyberdog_gazebo_cn
  **注意编译的时候要把`build`,`intall`,`log`这三个文件夹删掉再编译。**
  ![](/cyberdog/document/pictures/13.png)
  ...
  ![](/cyberdog/document/pictures/6.png)
  此时应该会弹出来几个控制台和GUI界面，但是此时**比赛场景加载不出来。**
  ![](/cyberdog/document/pictures/4.png)
  ![](/cyberdog/document/pictures/5.png)
  ...
  ![](/cyberdog/document/pictures/7.png)
...
- 其他例程
  ...
  ![](/cyberdog/document/pictures/8.png)
  ...
  ![](/cyberdog/document/pictures/9.png)
...
解决办法：
  ...
  ![](/cyberdog/document/pictures/15.png)
  ![](/cyberdog/document/pictures/16.png)
  再打开仿真，赛道就出现了（此时箭头，二维码仍没有）。
  ![](/cyberdog/document/pictures/17.png)
...
然后打开仿真，发现有箭头，二维码了
![](/cyberdog/document/pictures/18.png)
...
![](/cyberdog/document/pictures/10.png)
![](/cyberdog/document/pictures/11.png)
通过 `ros2 topic list`可确认 topic 正常发送
![](/cyberdog/document/pictures/12.png)
...
![alt text](/cyberdog/document/pictures/image.png)
